...
in.dir <- "/projectnb/talbot-lab-data/zrwerbin/NEON_16S_ITS_data_construction/data/ITS/filtSeqs/"
out.dir <- "/projectnb/talbot-lab-data/zrwerbin/NEON_16S_ITS_data_construction/data/ITS/seqTab/"
...
runDada2 <- function(filtpath, out.file, ...){
  tic()
